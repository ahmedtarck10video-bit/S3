...
data class TelemetryState(
  ...
  val isDepthTextureUploaded: Boolean = false,
  val isDepthTextureBound: Boolean = false,
  val isOcclusionShaderCompiled: Boolean = false,
  val isOcclusionMaterialAssigned: Boolean = false,
  val isGpuFragmentOcclusionActive: Boolean = false,
  val isGpuFragmentOcclusionRuntimeVerified: Boolean = false,
  val gpuOcclusionState: String = "DEPTH_UNAVAILABLE",
